...
#
# Parallel to scripts/common.sh -- same env knobs (BONSAI_PACKAGE_MIN_AGE_DAYS,
# BONSAI_DISABLE_HF_TRANSFER, ...) and the same helper names (`info`, `warn`,
# `err`, `step`, `download`, `Default-Model`, ...).
